...
(function() {
      ...
      this._handleKeyDown = (function(_this) {
        return function(ev) {
          ...
          if (element && !element.content) {
            if (ContentTools.EditorApp.get().activeTool()) {
              return;
            }
            if (element.isFixed()) {
              return;
    ...
    ToolUI.prototype.apply = function(element, selection) {
      ...
      callback = (function(_this) {
        return function(applied) {
          if (applied) {
            _this.dispatchEvent(_this.createEvent('applied', detail));
          }
          return ContentTools.EditorApp.get().activeTool(null);
        };
      })(this);
      if (this.dispatchEvent(this.createEvent('apply', detail))) {
        this.tool.apply(element, selection, callback);
        return ContentTools.EditorApp.get().activeTool(this.tool);
      }
    };
  ...
  _EditorApp = (function(_super) {
    ...
    _EditorApp.prototype.activeTool = function(tool) {
      if (tool === void 0) {
